...
export class UserService {
  ...
  static registerUserService = async (input: RegisterUserRequestType): Promise<SessionType> => {
  ...
  static loginUser = async (credentials: LoginUserRequestType): Promise<SessionType> => {
    const jsonSignature = process.env.JSON_SIGNATURE;
